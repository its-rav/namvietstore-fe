...
const TopBar: React.FC<TopBarProps> = ({
    ...
    return (
        <div className={`${className} container bg-primary flex flex-row items-center w-screen`}>
            <div className = {"ContactIcon basis-8 shrink-0" +
            ...
            <div className = {"LanguageButon scale-[95%] py-3  " +
                "ml-auto md:me-8"} >
                {languageButton}
            </div>
        </div>
